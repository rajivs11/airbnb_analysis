...
Report:
    ...
    4. Results, Conclusion, and Future Work
        ...
        Strengths:
            ...
            2. Able to Visualize Proximities to Crime
...
def user_choice(location):
    ...
    max_price = float(input("What is the maximum price you are willing to pay? \n$"))
...
def visualize_map(select_airbnb, crimes_refined, cheapest_option, safest_option):
    ...
    # creates scatterplot for crime reports
    plt.scatter(crimes_lat, crimes_long, marker = ".", s = 10, color = "RED", alpha = 0.1,
                label = "Crime Reports")
    
    # creates scatterplot for airbnb locations 
    ...
    # prints report with cheapest option url, price, and safest option url in chosen neighborhood
    print(f"\nIn {location}:")
